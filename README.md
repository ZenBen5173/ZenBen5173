...
### [UniGuide](https://github.com/ZenBen5173/UNiguide) — *UMHackathon 2026 Finalist*
...
- **Live demo:** [uniguide-blush.vercel.app](https://uniguide-blush.vercel.app) (no password — pick a role tile)
- **Stack:** Next.js 15, TypeScript, Supabase (Postgres + pgvector + Realtime), Z.AI GLM-4.6, Vercel

### GustFlow — FlowNote Solutions

Multi-tenant SaaS workflow platform deployed in production at a Malaysian hardware company. SOP management, task routing, department admin, and role-based access control.

- **Role:** Co-Founder · end-to-end product development
- **Stack:** Next.js, TypeScript, Supabase, Tailwind, Vercel

### [AgroSim](https://github.com/ZenBen5173/agrosimulator)
...
- **Live demo:** [agrosimulator.vercel.app](https://agrosimulator.vercel.app)
